package com.pucminas.fpaa.divisaoEConquista;
...
import com.pucminas.fpaa.model.LeilaoSolverDivisaoEConquista;
...
public class divisaoEConquista {
    ...
    @Test
    void testDivisaoEConquitaPerformance() {
        int tamanhoAtual = 10;
    ...
    private ResultadoDTO executarTeste(Long empresaId) {
        ...
        try {
            resultado = divisaoEConquista.InicializaLeilao(empresaId);
        } catch (Exception e) {
