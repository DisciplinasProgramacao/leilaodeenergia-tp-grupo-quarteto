package com.pucminas.fpaa.programacaoDinamica;
...
import com.pucminas.fpaa.model.LeilaoSolverProgramacaoDinamica;
...
public class programacaoDinamica {
    ...
    private ResultadoDTO executarTeste(Long empresaId) {
        ...
        try {
            resultado = programacaoDinamica.resolverLeilaoProgramacaoDinamica(empresaId);
        } finally {
